...
Stream.prototype._initSocketioTransport = function(transport) {
  ...
  if( !this.transport.key ) throw new Error('Initialization error: missing API AccessKey');
 ...
 * This method should be called before any subscription is made otherwise
 * it will be ignored.
 *
...
Stream.prototype.unsubscribe = function(channel, resource) {
  var vargs = {};
  vargs.channel = channel;
  vargs.resource = resource || this.wildcard;

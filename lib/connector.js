/**
 * @Author: Bachar Wehbi
 * @Date:   2015-05-01T23:23:43+02:00
 * @Email:  support@beebotte.com
 * @Project: Beebotte Commons
 * @Filename: connector.js
 * @Last modified by:   Bachar Wehbi
 * @Last modified time: 2017-03-29T01:02:33+02:00
 * @License: Unauthorized copying of this file, via any medium is strictly prohibited
 * Proprietary and confidential
 * @Copyright: Copyright (C) Beebotte, Corp - All Rights Reserved.
 */
...
BBT.Signer = function(apiKey, secretKey) {
    if(!apiKey || !secretKey) throw new Error('(BBT.Signer) Parameter Error: You must provide your key ID and your secret key!');
    this.apiKey = apiKey;
    this.sKey = secretKey;
}
...
var getResourceSchema = {
    channel: joi.string().regex(/^\w+$/).min(2).max(30).required(),
    resource: joi.string().regex(/^(\w\w+|\*)$/).max(30).optional(),
}
